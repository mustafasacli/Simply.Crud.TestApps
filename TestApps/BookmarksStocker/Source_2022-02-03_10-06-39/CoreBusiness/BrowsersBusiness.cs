using Bookmarks.Project.BusinessCore.Interfaces;
using Bookmarks.Project.CoreContext;
...
namespace Bookmarks.Project.BusinessCore
{
    /// <summary>
    ...
    public class BrowsersBusiness : SimpleBaseBusiness, IBrowsersBusiness
    {
        ...
        public SimpleResponse<BrowsersViewModel> Create(BrowsersViewModel model)
        {
            ...
            try
            {
                ...
                using (var context = new BookmarksProjectCoreDbContext())
                {
